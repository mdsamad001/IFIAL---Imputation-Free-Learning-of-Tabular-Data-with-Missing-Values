...
class TrainCollator:
    '''A base class for all collate function used for ifial training.
    '''
    def __init__(self,
        ...
        **kwargs,
        ...
        self.feature_extractor=ifialFeatureExtractor(
...
class ifialCollatorForCL(TrainCollator):
    '''support positive pair sampling for contrastive learning of ifial model.
    '''
    def __init__(self, 
        categorical_columns=None,
        numerical_columns=None,
