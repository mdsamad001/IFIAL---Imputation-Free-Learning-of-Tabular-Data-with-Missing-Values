...
from .modeling_ifial import ifialClassifier, ifialFeatureExtractor, ifialFeatureProcessor
#from .modeling_ifial import ifialForCL
from .modeling_ifial import ifialInputEncoder, ifialModel
from .dataset import load_data
from .evaluator import predict, evaluate
from .trainer import Trainer
from .trainer_utils import ifialCollatorForCL
...
def build_classifier(
    ...
    device='cuda:0',
    checkpoint=None,
    **kwargs) -> ifialClassifier:
    '''Build a :class:`ifial.modeling_ifial.ifialClassifier`.
    ...
    checkpoint: str
        the directory to load the pretrained ifial model.
...
def build_extractor(
    ...
    checkpoint=None,
    **kwargs,) -> ifialFeatureExtractor:
    '''Build a feature extractor for ifial model.
    ...
    checkpoint: str
        the directory of the predefined ifialFeatureExtractor.

    Returns
    -------
    A ifialFeatureExtractor module.
...
def build_encoder(
    ...
    **kwargs,
    ...
    if num_layer == 0:
        ...
        enc = ifialInputEncoder(feature_extractor, feature_processor)
        enc.load(checkpoint)
...
def build_contrastive_learner(
    ...
    **kwargs,
    ...
    '''Build a contrastive learner for pretraining based on ifial.
    ...
    checkpoint: str
        the directory of the pretrained ifial model.
...
def train(model, 
    ...
    **kwargs,
    ...
    '''
    The shared train function for all ifialModel based models.

    Parameters
    ----------
    model: ifialModel and its subclass
