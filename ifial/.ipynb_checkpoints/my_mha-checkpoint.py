...
def my_multi_head_attention_forward(
    ...
    if need_weights:
        ...
        if attn_mask is not None:
                ...
                bmask = torch.where(attn_mask==0,1,0)
                #print(bmask)
                bmaskT = bmask.transpose(-1,-2)
                bmask = bmask.mul(bmaskT)
                #print('attn_output_weights before:',attn_output_weights)
                #print('bmask', bmask)
                #print('bmask.shape:', bmask.shape)
                #print('bmaskT.shape:', bmaskT.shape)
                #print('attn_output_weights',attn_output_weights.shape)
                attn_output_weights = attn_output_weights* bmask.float()
                #print('attn_output_weights after:',attn_output_weights)
        if dropout_p > 0.0:
